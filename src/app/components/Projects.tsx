      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[var(--text-secondary)] max-w-3xl mx-auto">
            From full-stack applications to AI-powered tools, here's a showcase
            of my technical journey
          </p>
        </div>
        ...
        {/* Call to Action */}
        <div className="text-center bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-xl p-8 hover:border-[#00a3a9]/50 transition-all duration-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-3 bg-[var(--bg-tertiary)] border-2 border-[var(--border-color)] text-[var(--text-primary)] rounded-lg hover:border-[var(--accent-purple)] hover:text-[var(--accent-purple)] transition-all duration-300 font-medium"
            >
